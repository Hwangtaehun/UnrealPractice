...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACodingTestActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACodingTestActor_Add, "Add" }, // 150685122
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACodingTestActor_Statics::NewProp_number2 = { "number2", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACodingTestActor, number2), METADATA_PARAMS(Z_Construct_UClass_ACodingTestActor_Statics::NewProp_number2_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACodingTestActor_Statics::NewProp_number2_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACodingTestActor, 1514839523);
